  ...
  const drawer = (
    <div>
      ...
      <List>
        ...
        <ListItem  disablePadding onClick={()=> Navigate('/managementLogin')}>
            <ListItemButton>
              {/* <ListItemIcon>
                  <Home />
              </ListItemIcon> */}
        ...
        <ListItem  disablePadding onClick={()=> Navigate('/recruiterLogin')}>
            <ListItemButton>
              {/* <ListItemIcon>
                  <Home />
              </ListItemIcon> */}
              <ListItemText>Recruiters</ListItemText>
            </ListItemButton>
        </ListItem>

        <ListItem  disablePadding onClick={()=> Navigate('/candidateLogin')}>
            <ListItemButton>
              {/* <ListItemIcon>
                  <Home />
              </ListItemIcon> */}
        ...
        <ListItem  disablePadding onClick={()=> Navigate('/clientLogin')}>
            <ListItemButton>
              {/* <ListItemIcon>
                  <Home />
              </ListItemIcon> */}
